...
#' @param settings_sims A list containing model simulation settings from
...
#' @param obs_eval A data frame containing observational data used for model
...
sbs_calib_eval_sofun <- function(settings_calib,
                                 settings_eval,
                                 settings_sims,
                                 settings_input,
                                 df_drivers,
...
#' Conducts an site-by-site calibration (helper function)
#'
#' function to assist in the site by site comparison
#'
#' @param evalsite which site to evaluate
#' @param settings_calib A list containing model calibration settings.
#' See vignette_rsofun.pdf for more information and examples.
#' @param settings_eval A list specifying evaluation settings
#' (see vignette eval_sofun.pdf for more information and examples)
...
#' See vignette_rsofun.pdf for more information and examples.
#' @param df_drivers xxx
#' @param settings_input additional settings
...
sbs_calib_eval_sofun_bysite <- function(evalsite,
                                        settings_calib,
                                        settings_eval,
                                        settings_sims,
                                        settings_input,
                                        ...
                                        obs_eval,
                                        overwrite) {
  message(paste("sbs_calib_eval_sofun_bysite() for site", evalsite))
