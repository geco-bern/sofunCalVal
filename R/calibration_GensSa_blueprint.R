...
# run this if using phydro branch

driver$params_siml[[1]]$use_gs <- driver$params_siml[[1]]$use_phydro <- driver$params_siml[[1]]$use_pml <- driver$params_siml[[2]]$use_gs <- driver$params_siml[[2]]$use_phydro <- driver$params_siml[[2]]$use_pml <- FALSE
...
test_driver <- driver[!(driver$sitename %in% train_sitename),]

test_validation <- validation[!(validation$sitename %in% train_sitename),]
