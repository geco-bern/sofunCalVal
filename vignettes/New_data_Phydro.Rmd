...
# !!! select your path to whc_2m.nc in line 116

# !!! after rebuilding rsofun, restar R (in session)
...
# change the whc to previous values !!! select your path to whc_2m.nc
...
df_dday_agg %>% 
  ...
  labs(
    x = "Days after drought onset",
    y = expression( paste( "Bias LE (j m"^{-1}, " d"^{-1}, ")")) 
    ) +
  theme_classic() +
  theme(
    panel.grid.major.y = element_line(),
