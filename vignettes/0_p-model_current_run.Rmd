...
Calibrate parameters for five folds, determined by spatial (leave-site-out) cross-validation. This creates five files containing calibrated parameters and the BayesianTools model object returned from the MCMC.
```{r}
system(paste(here::here("src/submit_byfold.sh"), here::here()))
```
