...
# Load functions
source( here("my_stuff","eval_sofun.R"))
source(here("my_stuff/get_stats.R"))
source(here("my_stuff/analyse_modobs2.R"))
source(here("my_stuff/align_events.R"))
source(here("my_stuff/eval_droughtresponse.R"))
source(here("my_stuff/heatscatter_dependencies.R"))
...
# flue_sites <- readr::read_csv(here::here("my_stuff/flue_stocker18nphyt.csv")) %>%
#   dplyr::filter( !is.na(cluster) ) %>%
#   distinct(site) %>%
#   pull(site)

# model forcing data
driver <- read_rds("/data_2/FluxDataKit/v3.4/zenodo_upload/rsofun_driver_data_v3.4.rds")

fdk_site_info <- read_csv(here("my_stuff/fdk_site_info.csv"))

fdk_filter <-  read_csv(here("my_stuff/fdk_site_fullyearsequence.csv"))
...
df_flue <-  read_csv(here("my_stuff/flue_stocker18nphyt.csv"))
...
# !!! this is optional, need to ask to beni

# keep_le <- read.table(here("my_stuff/keep_le.txt"))
# 
# driver <- driver[which(driver$sitename %in% keep_le$V1),]

# load previous data for the structure
load(here("my_stuff/obs_eval_fluxnet2015.Rdata"))
```
...
nc_file <- nc_open(here("my_stuff/whc_2m.nc"))
