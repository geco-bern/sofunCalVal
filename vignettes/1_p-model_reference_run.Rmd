...
This workflow runs the P-model as implemented in {rsofun} for the reference version.
...
```{r}
# source(here::here("analysis/01_submit_calibration_current_run.R"))
par_calib <- readRDS(here::here("data/par_calib_fold_3.rds")) # XXX to be replaced
```
