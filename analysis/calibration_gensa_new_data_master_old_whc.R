...
train_sitename <- train_test_division(fdk_site_info,0.75)
...
pars_75$sitename <- train_sitename

write_rds(pars_75,"~/data_scratch/sofuncalvalGPP/sofuncalvalGPP/data/calibration/calibration_new_data_75.rds")
